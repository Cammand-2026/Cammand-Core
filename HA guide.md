Generic Camera
The Generic Camera integration allows you to integrate any IP camera or other URL into Home Assistant. Templates can be used to generate the URLs on the fly.
...
Advanced settings
Advanced settings are only needed for special cases. Leave them unchanged unless you know what you are doing.
...
Screenshot showing Google Maps integration in Home Assistant front end.Example showing the Generic camera platform pointing at a dynamic Google Map image.Screenshot showing Google Maps integration in Home Assistant front end.Example showing the Generic camera platform pointing at a dynamic Google Map image.
...
Live stream 
To access a camera that has both a snapshot and live stream URL, utilizing the stream integration.
