# ImageNet ILSVRC 2012 — 1000 클래스명 (index 순서)
IMAGENET_CLASSES: tuple[str, ...] = (
    ...
    "banjo", "barbell", "barber chair", "barbershop", "barn",
    ...
    "bumper car", "burrito", "bus", "butcher shop", "cab",
    ...
    "pickelhaube", "picket fence", "pier", "piggy bank", "pill bottle",
    "pillow", "ping-pong ball", "pinwheel", "pirate", "pitcher",
    "plane", "planetarium", "plastic bag", "plate rack", "plow",
    "plunger", "Polaroid camera", "pole", "police van", "poncho",
    "pool table", "pop bottle", "pot", "potter's wheel", "power drill",
    "prayer rug", "printer", "prison", "projectile", "projector",
    "punching bag", "purse", "quill", "quilt", "racer",
    ...
    "rubber eraser", "rugby ball", "ruler", "running shoe", "safe",
    "safety pin", "saltshaker", "sandal", "sarong", "sax",
    "scabbard", "scale", "school bus", "schooner", "scoreboard",
    "screen", "screw", "sewing machine", "shield", "shoe shop",
    ...
    "toilet tissue", "baseball bat", "tennis racket", "bow",
    "hair drier", "toothbrush", "wine glass", "cup", "fork", "knife",
)
